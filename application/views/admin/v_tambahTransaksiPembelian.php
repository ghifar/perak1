            ...
            <div class="span12">
                <div class="widget-box">
                    ...
                    <div class="widget-content nopadding">
                        <form class="form-horizontal" method="post" action="<?php echo site_url('admin/c_prosesTambahTransaksiPembelian');?>">
                            ...
                            <div class="control-group">
                                ...
                                <div class="field_wrapper">
                                    <div class="controls">
                                        ...
                                        <input type="text" name="banyak" placeholder="Qty" class="span1 m-wrap" onchange=javascript:Estimate(this.form); />
                                        <input type="text" name="harga" placeholder="Harga" class="span3 m-wrap" onchange=javascript:Estimate(this.form);  />
                            ...
                            <div class="control-group">
                              <label class="control-label">Total</label>
                                <div class="controls">
                                    <input maxlength=9 name=total readOnly size=6>&nbsp;&nbsp;&nbsp;
                                </div>
                            </div>
